var Emergence = {
  ...
  init :  function(width){
    ...
    Emergence.world.fetch(function(data){
      ...
      var lion = new Thing('lion.png', 45, 34).render(4,4);
      var meat = new Thing('meat.png', 40, 23).render(5,4);
      var hyena = new Thing('hyena.png', 40, 37).render(6,4);
      var leopard = new Thing('leopard.png', 45, 31).render(3,6);
      var rabbit = new Thing('rabbit.png', 37, 40).render(4,6);
